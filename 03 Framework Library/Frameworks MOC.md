...
```mermaid
flowchart LR
    Q["Recurring problem or pattern"] --> F["Framework<br/>understand the pattern"]
    F --> P["Program<br/>experience one insight"]
    F --> W["Workshop<br/>practice a focused arc"]
    F --> C["Curriculum<br/>serve a sustained Story"]
    P -. "feedback" .-> F
    W -. "feedback" .-> F
    C -. "feedback" .-> F
```
